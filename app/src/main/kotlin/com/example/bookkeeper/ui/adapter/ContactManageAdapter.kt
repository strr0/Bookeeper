...
class ContactManageAdapter(context: Context?) : RecyclerView.Adapter<ContactManageAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = inflater.inflate(R.layout.contact_manage_item, parent, false)
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        val avatar: TextView = view.findViewById(R.id.contact_manage_avatar)
        val name: TextView = view.findViewById(R.id.contact_manage_name)
        val phone: TextView = view.findViewById(R.id.contact_manage_phone)
        val chevron: View = view.findViewById(R.id.contact_manage_chevron)
    }
}
